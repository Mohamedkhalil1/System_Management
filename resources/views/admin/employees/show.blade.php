...
@section('title',"عرض الموظف | $employee->name")
@section('content')
<div class="app-content content">
    <div class="content-wrapper">
      <div class="content-header row">
        <div class="content-header-left col-md-6 col-12 mb-2">
          <h3 class="content-header-title">{{$employee->name}}</h3>
          <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{$employee->name}}
                </li>
              </ol>
            </div>
          </div>
                ...
                <div class="card-head">
                  <div class="card-header">
                    ...
                    <div class="heading-elements">
                         <span class="badge badge-default badge-danger">{{$employee->phone}}</span>
                      <span class="badge badge-default badge-warning">{{$employee->address}}</span>
                      <span class="badge badge-default badge-success">{{$employee->email}}</span>
                  ...
                  <div class="px-1">
                    <ul class="list-inline list-inline-pipe text-center p-1 border-bottom-grey border-bottom-lighten-3">
                      <li>الفرع المسئول عن الموظف  :
                        <span class="text-muted">{{$employee->branch ? $employee->branch->name : ''}}</span>
                      </li>
                      <li>
                        <span class="text-muted">{{$employee->created_at->format('Y-m-d')}}</span>
                      </li>
            ...
            <section id="dom" class="mt-3">
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"> فواتير بمراتبات الموظف </h4>
